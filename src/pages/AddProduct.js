                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <input type="text" onChange={(e)=>setDes(e.target.value)} name='description' placeholder='description' /> 
                      <select onChange={(e)=>setCategory(e.target.value)} >
                       ...
                       <option value="pizza">TSEC Canteen</option>
                       <option value="Burger">Chai Bugs</option>
                       <option value="Sandwich">Jay Sandwich</option>
                       <option value="Smoothy">Ravi Rice</option>
                       <option value="Snak">National Canteen</option>
                       <option value="Drink">Yogi's Sandwich</option>
                      </select>
